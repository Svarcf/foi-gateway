...
// prettier-ignore
import foiFootballTable, {
  FoiFootballTableState
} from 'app/entities/foi-football-table/foi-football-table.reducer';
...
export interface IRootState {
  ...
  readonly foiFootballTable: FoiFootballTableState;
